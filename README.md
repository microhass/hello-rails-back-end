...
**[hello-rails-back-end]** is a simple backend api for the react hello frontend site.

Here is the [Frontend Repo](https://github.com/microhass/hello-react-front-end)
...
- **Connect React with rails in 2 projects.**
...
```sh
  cd my-folder
  git clone github.com/microhass/hello-rails-back-end.git
```

Then navigate to `hello-rails-back-end` folder:
